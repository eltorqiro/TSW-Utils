 ...
 * 
 */
class __ProjectNamespace__.AddonUtils.GuiEditMode.GemOverlay extends UIComponent {
	
	public static var __className:String = "__ProjectNamespace__.AddonUtils.GuiEditMode.GemOverlay";
